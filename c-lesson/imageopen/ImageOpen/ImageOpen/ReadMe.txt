================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ImageOpen プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ImageOpen には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ImageOpen アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
ImageOpen.h
   ...
   CImageOpenApp アプリケーション クラスを宣言します。

ImageOpen.cpp
   これは、アプリケーション クラス CImageOpenApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\ImageOpen.ico
   ...
   アイコンはメイン リソース ファイル ImageOpen.rc に含まれていま
   す。
...
ImageOpenDlg.h, ImageOpenDlg.cpp - ダイアログ
   これらのファイルは CImageOpenDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な ImageOpen.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   ImageOpen.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
